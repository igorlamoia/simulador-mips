public class Converter {
    ...
    public MipsSimulator mips; // Use ele para trocar e pegar todas as variáveis
    ...
    //Retorna o número binário referente também no formato de string, caso necess�rio, completa o número binário de modo a ter 16 bits ao final
    ...
    //Recebe um número hexadecimal armazenado no formato de string
    //Retorna o número binário referente também no formato de string, caso necess�rio, completa o número binário de modo a ter 26 bits ao final
    //Usado para o 'j'
