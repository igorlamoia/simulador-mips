...
public class Main {
	public static void main(String args[]) throws IOException {
        ...
        //A partir de um texto com c�digo em assembly MIPS (cod_asm.txt)
        //Ser� gerado um arquivo em hexadecimal (cod_hexadecimal.txt) contendo cada instru��o em uma linha do arquivo
